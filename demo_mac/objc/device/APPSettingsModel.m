...
#import "APPSettingsModel+Private.h"
#import "APPSettingsStore.h"
...
- (APPSettingsStore *)settingsStore {
  if (!_settingsStore) {
    _settingsStore = [[APPSettingsStore alloc] init];
    [self registerStoreDefaults];
  }
...
- (void)registerStoreDefaults {
  ...
  [APPSettingsStore setDefaultsForVideoResolution:[self defaultVideoResolutionSetting]
